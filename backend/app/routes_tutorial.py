...
def _seed_tutorial_store(industry="technology", size_tier="mid"):
    ...
    _TECH_HIERARCHY = {
        ...
        "VP Engineering":           ("Engineering Leadership", "Executive", ["L6"]),
        ...
        # Product
        "Associate PM":        ("Product Management", "Product Discovery", ["L2"]),
        "Product Manager":     ("Product Management", "Product Strategy", ["L3","L4"]),
        "Senior PM":           ("Product Management", "Product Strategy", ["L4","L5"]),
        "UX Designer":         ("Design", "UX & Interaction Design", ["L3"]),
        "Director of Product": ("Product Management", "Product Leadership", ["L5"]),
        "VP Product":          ("Product Management", "Product Leadership", ["L6"]),
        "UX Researcher":       ("Design", "User Research", ["L3","L4"]),
        "Product Analyst":     ("Product Management", "Product Analytics", ["L2","L3"]),
        # Data & Analytics
        "Data Analyst":        ("Data & BI", "Business Intelligence", ["L3"]),
        "Senior Data Analyst": ("Data & BI", "Analytics & Reporting", ["L4"]),
        "Data Engineer":       ("Data & BI", "Data Engineering", ["L3","L4"]),
        "Data Scientist":      ("Data Science", "Applied Machine Learning", ["L4"]),
        "ML Engineer":         ("Data Science", "ML Engineering & MLOps", ["L4"]),
        "Analytics Engineer":  ("Data & BI", "Analytics Engineering", ["L3","L4"]),
        "Analytics Manager":   ("Data & BI", "BI Management", ["L4"]),
        "VP Data":             ("Data Leadership", "Executive", ["L6"]),
        # IT Operations
        "IT Support":    ("IT Services", "Service Desk & End User", ["L2"]),
        "Sys Admin":     ("IT Services", "Infrastructure & Networking", ["L3"]),
        "DevOps Engineer": ("Platform Engineering", "DevOps & CI/CD", ["L3"]),
        "SRE":           ("Platform Engineering", "Site Reliability", ["L4"]),
        "IT Manager":    ("IT Services", "IT Management", ["L4"]),
        "Director IT":   ("IT Services", "IT Leadership", ["L5"]),
        # Security
        "Security Analyst":  ("Cybersecurity", "Security Operations Center", ["L3"]),
        "Security Engineer": ("Cybersecurity", "Security Engineering", ["L4"]),
        "Pen Tester":        ("Cybersecurity", "Offensive Security & Red Team", ["L3"]),
        "Security Manager":  ("Cybersecurity", "Security Management", ["L4"]),
        "CISO":              ("Cybersecurity", "Security Leadership", ["L6"]),
        # Sales & Marketing
        "SDR":                  ("Sales", "Business Development", ["L2"]),
        "Account Executive":    ("Sales", "Enterprise Sales", ["L3"]),
        "Marketing Specialist": ("Marketing", "Demand Generation & Growth", ["L3"]),
        "Content Strategist":   ("Marketing", "Content & Brand", ["L3"]),
        "Sales Manager":        ("Sales", "Sales Management", ["L4"]),
        "VP Marketing":         ("Marketing", "Marketing Leadership", ["L6"]),
        "VP Sales":             ("Sales", "Sales Leadership", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Budgeting & Forecasting", ["L3"]),
        "Accountant":        ("Accounting", "General Ledger", ["L3"]),
        "FP&A Manager":      ("FP&A", "Management Reporting", ["L4"]),
        "Controller":        ("Accounting", "Controllership", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Accounts Payable & Receivable", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Tax Operations", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "HR Shared Services", ["L2"]),
        "HRBP":            ("HR Business Partners", "Business Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Sourcing & Recruiting", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Training & Programs", ["L3"]),
        "HR Manager":      ("HR Operations", "HR Management", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Compensation Analytics", ["L3"]),
        # Legal
        "Paralegal":          ("Legal Operations", "Paralegal Services", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Corporate & Commercial Law", ["L4"]),
        "Compliance Analyst": ("Compliance", "Regulatory Compliance", ["L3"]),
        "Privacy Officer":    ("Compliance", "Data Privacy & Protection", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "Contract Management", ["L3"]),
    }
    ...
    _FINSERV_HIERARCHY = {
        ...
        "VP Engineering":           ("Technology Leadership", "Executive", ["L6"]),
        ...
        "UX Designer":         ("Trading & Markets", "Trading Analytics", ["L3"]),
        "Director of Product": ("Deal Execution", "Deal Leadership", ["L5"]),
        "VP Product":          ("Investment Banking Leadership", "Executive", ["L6"]),
        ...
        "Data Scientist":      ("Quantitative Research", "Model Development", ["L4"]),
        "ML Engineer":         ("Quantitative Research", "Quantitative Strategies", ["L4"]),
        "Analytics Manager":   ("Quantitative Risk", "Risk Management", ["L4"]),
        "VP Data":             ("Risk Leadership", "Executive", ["L6"]),
        ...
        "Security Analyst":  ("Regulatory Affairs", "Banking Regulation", ["L3"]),
        "Security Engineer": ("Regulatory Affairs", "Securities Compliance", ["L4"]),
        "Pen Tester":        ("Surveillance", "Trade Surveillance & AML", ["L3"]),
        "Security Manager":  ("Regulatory Affairs", "Compliance Management", ["L4"]),
        "CISO":              ("Compliance Leadership", "Executive", ["L6"]),
        # Wealth Management (renamed from Sales & Marketing)
        "SDR":                  ("Private Banking", "Client Onboarding", ["L2"]),
        "Account Executive":    ("Private Banking", "Client Advisory", ["L3"]),
        "Marketing Specialist": ("Private Banking", "Wealth Strategy", ["L3"]),
        "Content Strategist":   ("Private Banking", "Portfolio Management", ["L3"]),
        "Sales Manager":        ("Private Banking", "Relationship Management", ["L4"]),
        "VP Marketing":         ("Wealth Management Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Wealth Management Leadership", "Executive", ["L6"]),
        # Treasury (renamed from Finance)
        "Financial Analyst": ("Treasury", "Liquidity Management", ["L3"]),
        "Accountant":        ("Fund Accounting", "NAV & Valuations", ["L3"]),
        "FP&A Manager":      ("Treasury", "Capital Planning", ["L4"]),
        "Controller":        ("Fund Accounting", "Financial Control", ["L5"]),
        "AP/AR Specialist":  ("Fund Accounting", "Settlements & Payments", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Fund Accounting", "Tax & Regulatory Reporting", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "HRIS & Shared Services", ["L2"]),
        "HRBP":            ("HR Business Partners", "Front Office Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Campus & Experienced Hire", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Professional Development", ["L3"]),
        "HR Manager":      ("HR Operations", "HR Management", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Compensation Design", ["L3"]),
        # Legal & Regulatory (renamed from Legal)
        "Paralegal":          ("Legal Operations", "Transactional Support", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Securities & Transactional Law", ["L4"]),
        "Compliance Analyst": ("Regulatory", "SEC & FINRA Compliance", ["L3"]),
        "Privacy Officer":    ("Regulatory", "Data Governance", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "ISDA & Documentation", ["L3"]),
    }

    _HEALTHCARE_HIERARCHY = {
        # Health Informatics (renamed from Engineering)
        "Junior Software Engineer": ("Clinical Systems", "EHR Administration", ["L2"]),
        "Software Engineer":        ("Clinical Systems", "Clinical Applications", ["L2","L3"]),
        "Senior Software Engineer": ("Clinical Systems", "Integration & Interoperability", ["L3","L4"]),
        "Staff Engineer":           ("Clinical Systems", "Health IT Architecture", ["L4","L5"]),
        "Engineering Manager":      ("Clinical Systems", "Health IT Management", ["L4"]),
        "Sr Engineering Manager":   ("Clinical Systems", "Health IT Management", ["L5"]),
        "VP Engineering":           ("Health Informatics Leadership", "Executive", ["L6"]),
        ...
        "Director of Product": ("Clinical Operations Leadership", "Clinical Programs", ["L5"]),
        "VP Product":          ("Clinical Operations Leadership", "Executive", ["L6"]),
        ...
        "VP Data":             ("Revenue Cycle Leadership", "Executive", ["L6"]),
        # IT Services (renamed from IT Operations)
        "IT Support":    ("IT Services", "Help Desk & Desktop Support", ["L2"]),
        "Sys Admin":     ("IT Services", "Network & Infrastructure", ["L3"]),
        "DevOps Engineer": ("IT Services", "Clinical Systems Support", ["L3"]),
        "SRE":           ("IT Services", "Infrastructure Reliability", ["L4"]),
        "IT Manager":    ("IT Services", "IT Operations Management", ["L4"]),
        "Director IT":   ("IT Services", "IT Leadership", ["L5"]),
        # Quality & Safety (renamed from Security)
        "Security Analyst":  ("Quality Improvement", "Performance Metrics & Accreditation", ["L3"]),
        "Security Engineer": ("Quality Improvement", "Process Improvement", ["L4"]),
        "Pen Tester":        ("Patient Safety", "Risk Management & Reporting", ["L3"]),
        "Security Manager":  ("Patient Safety", "Infection Control", ["L4"]),
        "CISO":              ("Quality & Safety Leadership", "Executive", ["L6"]),
        ...
        "VP Marketing":         ("Patient Services Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Patient Services Leadership", "Executive", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Budgeting & Forecasting", ["L3"]),
        "Accountant":        ("Accounting", "General Accounting", ["L3"]),
        "FP&A Manager":      ("FP&A", "Financial Reporting", ["L4"]),
        "Controller":        ("Accounting", "Reimbursement & Payer Relations", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Accounts Payable", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Tax & Regulatory Reporting", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "Employee Services", ["L2"]),
        "HRBP":            ("HR Business Partners", "Clinical Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Clinical Recruiting", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Clinical Education & Training", ["L3"]),
        "HR Manager":      ("HR Operations", "Workforce Planning & Scheduling", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Benefits & Compensation", ["L3"]),
        # Compliance (renamed from Legal)
        "Paralegal":          ("Regulatory Compliance", "HIPAA & Privacy", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Healthcare Law", ["L4"]),
        "Compliance Analyst": ("Regulatory Compliance", "Joint Commission & CMS", ["L3"]),
        "Privacy Officer":    ("Regulatory Compliance", "Health Information Management", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "Payer Contracts & Agreements", ["L3"]),
    }
    ...
    _MANUFACTURING_HIERARCHY = {
        ...
        "VP Product":          ("Production Leadership", "Executive", ["L6"]),
        ...
        "VP Data":             ("Quality Leadership", "Executive", ["L6"]),
        ...
        "Security Analyst":  ("EHS", "Workplace Safety", ["L3"]),
        "Security Engineer": ("EHS", "Environmental Compliance", ["L4"]),
        "Pen Tester":        ("EHS", "Industrial Hygiene", ["L3"]),
        "Security Manager":  ("EHS", "EHS Management", ["L4"]),
        "CISO":              ("EHS Leadership", "Executive", ["L6"]),
        # Supply Chain (renamed from Sales & Marketing)
        "SDR":                  ("Supply Chain", "Procurement & Sourcing", ["L2"]),
        "Account Executive":    ("Supply Chain", "Supplier Management", ["L3"]),
        "Marketing Specialist": ("Supply Chain", "Demand Planning", ["L3"]),
        "Content Strategist":   ("Supply Chain", "Logistics & Distribution", ["L3"]),
        "Sales Manager":        ("Supply Chain", "Supply Chain Management", ["L4"]),
        "VP Marketing":         ("Supply Chain Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Commercial Leadership", "Executive", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Cost Accounting & Analysis", ["L3"]),
        "Accountant":        ("Accounting", "Plant Accounting", ["L3"]),
        "FP&A Manager":      ("FP&A", "Budgeting & Variance Analysis", ["L4"]),
        "Controller":        ("Accounting", "Plant Controllership", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Accounts Payable", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Tax & Payroll", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "HR Administration", ["L2"]),
        "HRBP":            ("HR Business Partners", "Plant HR Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Skilled Trades Recruiting", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Safety & Technical Training", ["L3"]),
        "HR Manager":      ("HR Operations", "Labor Relations & Compliance", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Benefits Administration", ["L3"]),
        # Regulatory (renamed from Legal)
        "Paralegal":          ("Regulatory Affairs", "Regulatory Documentation", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Product Liability & IP", ["L4"]),
        "Compliance Analyst": ("Regulatory Affairs", "Environmental & Safety Compliance", ["L3"]),
        "Privacy Officer":    ("Regulatory Affairs", "Export Controls & Trade Compliance", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "Supplier Contracts & Procurement Law", ["L3"]),
    }
    ...
    _RETAIL_HIERARCHY = {
        ...
        "VP Product":          ("Merchandising Leadership", "Executive", ["L6"]),
        ...
        "VP Data":             ("Analytics Leadership", "Executive", ["L6"]),
        ...
        "CISO":              ("Loss Prevention Leadership", "Executive", ["L6"]),
        # Marketing (renamed from Sales & Marketing)
        "SDR":                  ("Marketing", "Loyalty & CRM", ["L2"]),
        "Account Executive":    ("Marketing", "Brand Partnerships", ["L3"]),
        "Marketing Specialist": ("Marketing", "Digital Marketing & Social", ["L3"]),
        "Content Strategist":   ("Marketing", "Content & Creative", ["L3"]),
        "Sales Manager":        ("Marketing", "Marketing Management", ["L4"]),
        "VP Marketing":         ("Marketing Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Commercial Leadership", "Executive", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Revenue Analysis & Forecasting", ["L3"]),
        "Accountant":        ("Accounting", "Lease & Store Accounting", ["L3"]),
        "FP&A Manager":      ("FP&A", "Financial Planning", ["L4"]),
        "Controller":        ("Accounting", "Controllership", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Vendor Payments & AP", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Sales Tax & Multi-State", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "Hourly Workforce Services", ["L2"]),
        "HRBP":            ("HR Business Partners", "Field HR Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "High-Volume & Seasonal Recruiting", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Retail Training & Onboarding", ["L3"]),
        "HR Manager":      ("HR Operations", "HR Management", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Compensation & Benefits", ["L3"]),
        # Legal
        "Paralegal":          ("Legal Operations", "Lease & Real Estate Support", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Commercial & Consumer Law", ["L4"]),
        "Compliance Analyst": ("Compliance", "Consumer Protection & Labeling", ["L3"]),
        "Privacy Officer":    ("Compliance", "Data Privacy & PCI", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "Vendor & Franchise Contracts", ["L3"]),
    }
    ...
    _LEGAL_HIERARCHY = {
        ...
        "VP Engineering":           ("Legal Technology Leadership", "Executive", ["L6"]),
        ...
        "VP Product":          ("Litigation Leadership", "Executive", ["L6"]),
        ...
        "VP Data":             ("Knowledge Management Leadership", "Executive", ["L6"]),
        # Legal Ops (renamed from IT Operations)
        "IT Support":    ("Legal Operations", "Practice Support", ["L2"]),
        "Sys Admin":     ("Legal Operations", "Document Management", ["L3"]),
        "DevOps Engineer": ("Legal Operations", "Billing & Time Systems", ["L3"]),
        "SRE":           ("Legal Operations", "Legal Project Management", ["L4"]),
        "IT Manager":    ("Legal Operations", "Operations Management", ["L4"]),
        "Director IT":   ("Legal Operations", "Operations Leadership", ["L5"]),
        ...
        "CISO":              ("Risk & Ethics Leadership", "Executive", ["L6"]),
        # Business Development (renamed from Sales & Marketing)
        "SDR":                  ("Business Development", "Client Intake & Proposals", ["L2"]),
        "Account Executive":    ("Business Development", "Client Relationship Management", ["L3"]),
        "Marketing Specialist": ("Business Development", "Events & Thought Leadership", ["L3"]),
        "Content Strategist":   ("Business Development", "Publications & Marketing", ["L3"]),
        "Sales Manager":        ("Business Development", "BD Management", ["L4"]),
        "VP Marketing":         ("Business Development Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Business Development Leadership", "Executive", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Practice Profitability Analysis", ["L3"]),
        "Accountant":        ("Accounting", "Trust Accounting", ["L3"]),
        "FP&A Manager":      ("FP&A", "Billing & Collections Management", ["L4"]),
        "Controller":        ("Accounting", "Financial Control", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Client Billing & Invoicing", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Partner Tax & Distribution", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "Onboarding & Administration", ["L2"]),
        "HRBP":            ("HR Business Partners", "Attorney & Staff Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Lateral & Associate Recruiting", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Associate Development & CLE", ["L3"]),
        "HR Manager":      ("HR Operations", "HR Management", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Partner Compensation & Benefits", ["L3"]),
        ...
        "General Counsel":    ("General Counsel Leadership", "Executive", ["L6"]),
    ...
    _ENERGY_HIERARCHY = {
        ...
        "VP Product":          ("Operations Leadership", "Executive", ["L6"]),
        ...
        "VP Data":             ("Asset Management Leadership", "Executive", ["L6"]),
        ...
        "CISO":              ("HSE Leadership", "Executive", ["L6"]),
        ...
        "VP Marketing":         ("Commercial Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Commercial Leadership", "Executive", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Capital Project Analysis", ["L3"]),
        "Accountant":        ("Accounting", "Joint Venture Accounting", ["L3"]),
        "FP&A Manager":      ("FP&A", "Reserves & Valuation", ["L4"]),
        "Controller":        ("Accounting", "Controllership", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Revenue Distribution & AP", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Severance & Property Tax", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "Field HR Services", ["L2"]),
        "HRBP":            ("HR Business Partners", "Operations HR Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Technical & Field Recruiting", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Safety & Competency Training", ["L3"]),
        "HR Manager":      ("HR Operations", "HR Management", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Compensation & Expat Programs", ["L3"]),
        # Legal
        "Paralegal":          ("Legal Operations", "Land & Mineral Rights", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Energy Regulatory & Environmental Law", ["L4"]),
        "Compliance Analyst": ("Regulatory Compliance", "Pipeline & Facility Compliance", ["L3"]),
        "Privacy Officer":    ("Regulatory Compliance", "NERC & FERC Compliance", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "Joint Venture & Offtake Agreements", ["L3"]),
    }
    ...
    _EDUCATION_HIERARCHY = {
        ...
        "VP Engineering":           ("IT Leadership", "Executive", ["L6"]),
        ...
        "VP Product":          ("Academic Affairs Leadership", "Executive", ["L6"]),
        # Institutional Research (renamed from Data & Analytics)
        "Data Analyst":        ("Institutional Research", "Enrollment Analytics", ["L3"]),
        "Senior Data Analyst": ("Institutional Research", "Outcomes & Assessment Research", ["L4"]),
        "Data Engineer":       ("Institutional Research", "Data Warehouse & Reporting", ["L3","L4"]),
        "Data Scientist":      ("Institutional Research", "Predictive Enrollment Modeling", ["L4"]),
        "ML Engineer":         ("Institutional Research", "Student Success Analytics", ["L4"]),
        "Analytics Manager":   ("Institutional Research", "IR Management", ["L4"]),
        "VP Data":             ("Institutional Research Leadership", "Executive", ["L6"]),
        # IT Operations
        "IT Support":    ("IT Services", "Help Desk & Desktop Support", ["L2"]),
        "Sys Admin":     ("IT Services", "Network & Classroom Technology", ["L3"]),
        "DevOps Engineer": ("IT Services", "Cloud & Infrastructure", ["L3"]),
        "SRE":           ("IT Services", "Systems Reliability", ["L4"]),
        "IT Manager":    ("IT Services", "IT Operations Management", ["L4"]),
        "Director IT":   ("IT Services", "IT Leadership", ["L5"]),
        ...
        "CISO":              ("Student Affairs Leadership", "Executive", ["L6"]),
        ...
        "VP Marketing":         ("Enrollment Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Advancement Leadership", "Executive", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Budget & Grant Accounting", ["L3"]),
        "Accountant":        ("Accounting", "General & Fund Accounting", ["L3"]),
        "FP&A Manager":      ("FP&A", "Financial Planning & Reporting", ["L4"]),
        "Controller":        ("Accounting", "Controllership", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Student Accounts & Billing", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Tax-Exempt & Endowment Accounting", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "Benefits & Employee Services", ["L2"]),
        "HRBP":            ("HR Business Partners", "Faculty & Staff Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Faculty Search & Staff Recruiting", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Professional Development & Workshops", ["L3"]),
        "HR Manager":      ("HR Operations", "HR Management", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Compensation & Classification", ["L3"]),
        # Legal
        "Paralegal":          ("Legal Operations", "Compliance Documentation", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Higher Education Law", ["L4"]),
        "Compliance Analyst": ("Compliance", "Title IX & FERPA Compliance", ["L3"]),
        "Privacy Officer":    ("Compliance", "Student Records & Data Privacy", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "Grants & Sponsored Research Contracts", ["L3"]),
    }
    ...
    _PROFSERV_HIERARCHY = {
        ...
        "VP Product":          ("Consulting Leadership", "Executive", ["L6"]),
        ...
        "VP Data":             ("Research Leadership", "Executive", ["L6"]),
        ...
        "CISO":              ("Risk Advisory Leadership", "Executive", ["L6"]),
        # Sales & Marketing → Business Development
        "SDR":                  ("Business Development", "Proposals & Pursuits", ["L2"]),
        "Account Executive":    ("Business Development", "Client Partnerships", ["L3"]),
        "Marketing Specialist": ("Business Development", "Thought Leadership & Events", ["L3"]),
        "Content Strategist":   ("Business Development", "Content & Brand Strategy", ["L3"]),
        "Sales Manager":        ("Business Development", "BD Management", ["L4"]),
        "VP Marketing":         ("Business Development Leadership", "Executive", ["L6"]),
        "VP Sales":             ("Business Development Leadership", "Executive", ["L6"]),
        # Finance
        "Financial Analyst": ("FP&A", "Practice Profitability", ["L3"]),
        "Accountant":        ("Accounting", "Engagement Accounting", ["L3"]),
        "FP&A Manager":      ("FP&A", "Revenue Forecasting", ["L4"]),
        "Controller":        ("Accounting", "Controllership", ["L5"]),
        "AP/AR Specialist":  ("Accounting", "Client Billing & WIP", ["L2"]),
        "CFO":               ("Finance Leadership", "Executive", ["L6"]),
        "Tax Specialist":    ("Accounting", "Partner Tax & Distributions", ["L3"]),
        # HR
        "HR Coordinator":  ("HR Operations", "HR Shared Services", ["L2"]),
        "HRBP":            ("HR Business Partners", "Practice HR Partnering", ["L3"]),
        "Recruiter":       ("Talent Acquisition", "Campus & Experienced Hire", ["L3"]),
        "L&D Specialist":  ("Learning & Development", "Consultant Development & Training", ["L3"]),
        "HR Manager":      ("HR Operations", "HR Management", ["L4"]),
        "VP People":       ("HR Leadership", "Executive", ["L6"]),
        "Comp Analyst":    ("Total Rewards", "Partner Compensation", ["L3"]),
        # Legal
        "Paralegal":          ("Legal Operations", "Contract Administration", ["L2"]),
        "Corporate Counsel":  ("Legal Advisory", "Professional Liability", ["L4"]),
        "Compliance Analyst": ("Compliance", "Independence & Ethics", ["L3"]),
        "Privacy Officer":    ("Compliance", "Data Protection & Privacy", ["L4"]),
        "General Counsel":    ("Legal Leadership", "Executive", ["L6"]),
        "Contract Manager":   ("Legal Operations", "Client Engagement Agreements", ["L3"]),
    }
