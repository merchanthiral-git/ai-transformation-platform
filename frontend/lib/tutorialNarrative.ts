...
export const NARRATIVES: StepNarrative[] = [
  ...
  },
  {
    stepId: "design",
    personas: {
      chro: { headline: "This is how a role evolves — not disappears", context: "The narrative matters. Roles don't vanish — they transform. This is the evidence.", insight: "Operations Analyst: 12 tasks automated, 4 augmented, 2 remain human. It becomes AI Operations Specialist.", callout: "Tell the board: 'We're evolving 420 roles, not eliminating them.'" },
