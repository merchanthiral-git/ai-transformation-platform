export default function NotFound() {
  return (
    <div style={{ minHeight: "100vh", background: "#0B1120", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Inter Tight', sans-serif" }}>
      <div style={{ textAlign: "center", maxWidth: 480, padding: 32 }}>
        <div style={{ fontSize: 80, fontWeight: 800, color: "rgba(244,168,58,0.15)", fontFamily: "monospace", lineHeight: 1, marginBottom: 16 }}>404</div>
        ...
        <a
          ...
          style={{
            ...
            background: "rgba(244,168,58,0.12)", border: "1px solid rgba(244,168,58,0.3)",
