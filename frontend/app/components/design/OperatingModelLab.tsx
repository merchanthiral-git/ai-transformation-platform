...
export const OM_GOVERNANCE: Record<string, { label: string; icon: string }> = {
  tight: { label: "Tight Governance", icon: "lock" }, balanced: { label: "Balanced", icon: "scale" }, light: { label: "Light Governance", icon: "waves" },
};
