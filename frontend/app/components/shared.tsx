...
export function ViewSelector({ onSelect, employees, jobs, filterOptions, onBack }: { 
  ...
  return <div style={{ position: "fixed", inset: 0, overflow: "auto", background: "#0B1120" }}>
    ...
    <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, #0B1120 0%, #1a1530 35%, #0f1525 65%, #0a0f1a 100%)", backgroundImage: "url(/view_bg.png)", backgroundSize: "cover", backgroundPosition: "center center", width: "100vw", height: "100vh" }} />
