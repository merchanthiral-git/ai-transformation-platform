...
const S = {
  ...
  colAction: (selected: boolean) => ({ display: "inline-flex", alignItems: "center", gap: 4, padding: "3px 8px", fontSize: 11, fontWeight: selected ? "var(--fw-semi)" : "var(--fw-medium)", border: `1px solid ${selected ? "#3B82F6" : "var(--border)"}`, borderRadius: 4, background: selected ? "rgba(59,130,246,0.08)" : "transparent", color: selected ? "#3B82F6" : "var(--text-muted)", cursor: "pointer", marginTop: 6 }) as React.CSSProperties,
