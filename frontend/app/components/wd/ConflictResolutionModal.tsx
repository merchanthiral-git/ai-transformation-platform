...
const S = {
  ...
  header: { display: "flex", alignItems: "center", gap: 10, padding: "16px 20px", borderBottom: "1px solid var(--border)", background: "#1C2B3A", flexShrink: 0 } as React.CSSProperties,
  ...
  resolvedBadge: { fontSize: 10, fontWeight: 600, padding: "2px 8px", borderRadius: 10, background: "rgba(34,197,94,0.1)", color: "#22C55E" } as React.CSSProperties,
  columns: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 0 } as React.CSSProperties,
  col: (active: boolean) => ({ padding: "12px 14px", background: active ? "rgba(59,130,246,0.04)" : "transparent", borderRight: "1px solid var(--border)", cursor: "pointer", transition: "background 0.1s" }) as React.CSSProperties,
  colLast: (active: boolean) => ({ padding: "12px 14px", background: active ? "rgba(59,130,246,0.04)" : "transparent", cursor: "pointer", transition: "background 0.1s" }) as React.CSSProperties,
  colLabel: { fontSize: 9, fontWeight: 600, color: "var(--text-muted)", textTransform: "uppercase" as const, letterSpacing: "0.06em", marginBottom: 4 } as React.CSSProperties,
  ...
  colAction: (selected: boolean) => ({ display: "inline-flex", alignItems: "center", gap: 4, padding: "3px 8px", fontSize: 10, fontWeight: selected ? "var(--fw-semi)" : "var(--fw-medium)", border: `1px solid ${selected ? "#3B82F6" : "var(--border)"}`, borderRadius: 4, background: selected ? "rgba(59,130,246,0.08)" : "transparent", color: selected ? "#3B82F6" : "var(--text-muted)", cursor: "pointer", marginTop: 6 }) as React.CSSProperties,
  ...
  commitBtn: { display: "inline-flex", alignItems: "center", gap: 4, padding: "8px 18px", fontSize: 12, fontWeight: "var(--fw-semi)", border: "none", borderRadius: 6, background: "#3B82F6", color: "#fff", cursor: "pointer" } as React.CSSProperties,
};
