      ...
      <div>
        ...
        <div style={S.section}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 10 }}>
            {CASE_TYPES.map(ct => (
              <button key={ct.key}
                style={{ padding: "4px 12px", fontSize: 11, fontWeight: caseType === ct.key ? "var(--fw-semi)" : "var(--fw-medium)", border: `1px solid ${caseType === ct.key ? "#3B82F6" : "var(--border)"}`, borderRadius: 14, background: caseType === ct.key ? "rgba(59,130,246,0.08)" : "var(--surface-2)", color: caseType === ct.key ? "#3B82F6" : "var(--text-muted)", cursor: "pointer" }}
