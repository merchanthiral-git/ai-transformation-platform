...
const DECISION_COLORS: Record<string, string> = {
  Retain: "#22C55E", Augment: "#3B82F6", Automate: "#EF4444",
  Redesign: "#F97316", Transfer: "#8B5CF6", Eliminate: "#9CA3AF",
};
...
const WATERFALL_COLORS = ["#3B82F6", "#EF4444", "#F97316", "#22C55E", "#8B5CF6"];
    ...
    <div>
      ...
      <div style={S.kpiRow}>
        ...
        <div style={S.kpi("var(--text-muted)")}>
          ...
          <div style={{ ...S.kpiValue, color: totalNewPct <= 100 ? "#22C55E" : "#EF4444" }}>{totalNewPct}%</div>
        </div>
      </div>
            ...
            <table style={S.table}>
              ...
              <tfoot>
                <tr>
                  ...
                  <td style={{ ...S.footer, fontFamily: "var(--ff-mono)", textAlign: "center", color: totalNewPct <= 100 ? "#22C55E" : "#EF4444" }}>{totalNewPct}%</td>
                  <td style={{ ...S.footer, fontFamily: "var(--ff-mono)" }}>
                    <span style={{ color: totalNewPct - totalCurrentPct < 0 ? "#22C55E" : "#EF4444" }}>
            ...
            <div style={S.section}>
              ...
              {recs.slice(0, 5).map((r, i) => (
                <div key={i} style={S.insightItem}>
                  <Sparkles size={11} style={{ color: "#3B82F6", flexShrink: 0, marginTop: 1 }} />
                  <span>{r}</span>
                </div>
              ))}
            </div>
