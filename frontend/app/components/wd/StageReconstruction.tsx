            ...
            <table style={S.table}>
              ...
              <tfoot>
                <tr>
                  ...
                  <td style={{ ...S.footer, fontFamily: "var(--ff-mono)", textAlign: "center", color: totalNewPct <= 100 ? "var(--sage)" : "var(--coral)" }}>{totalNewPct}%</td>
                  <td style={{ ...S.footer, fontFamily: "var(--ff-mono)" }}>
                    <span style={{ color: totalNewPct - totalCurrentPct < 0 ? "var(--sage)" : "var(--coral)" }}>
            ...
            {futureSkills.length > 0 ? futureSkills.slice(0, 10).map(([skill, info]) => (
              <div key={skill} style={S.skillRow}>
                ...
                <span style={{
                  ...
                  color: info.source === "New" ? "var(--amber)" : info.source === "Upgraded" ? "var(--amber)" : "var(--sage)",
                }}>{info.source}</span>
              </div>
            )) : (
            ...
            <div style={S.section}>
              ...
              {recs.slice(0, 5).map((r, i) => (
                <div key={i} style={S.insightItem}>
                  <Sparkles size={11} style={{ color: "var(--amber)", flexShrink: 0, marginTop: 1 }} />
                  <span>{r}</span>
                </div>
              ))}
            </div>
