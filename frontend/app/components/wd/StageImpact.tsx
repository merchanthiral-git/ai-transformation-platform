...
const S = {
  ...
  insightRow: { display: "flex", gap: 8, padding: "8px 12px", borderRadius: 6, marginBottom: 4, background: "rgba(59,130,246,0.03)", fontSize: "var(--text-xs)", color: "var(--text-secondary)" } as React.CSSProperties,
  ...
  return (
    <div>
      ...
      <div style={S.actionBar}>
        ...
        <button style={{ ...S.btnPrimary, background: reviewed ? "#22C55E" : "#3B82F6" }} onClick={() => setReviewed(true)}>
