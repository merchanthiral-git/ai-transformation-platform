...
const S = {
  ...
  header: { background: "var(--paper-solid)", padding: "16px 20px", flexShrink: 0 } as React.CSSProperties,
  ...
  tab: (active: boolean) => ({ flex: 1, padding: "10px 12px", fontSize: "var(--text-xs)", fontWeight: active ? "var(--fw-semi)" : "var(--fw-medium)", color: active ? "var(--amber)" : "var(--text-muted)", borderBottom: active ? "2px solid #f4a83a" : "2px solid transparent", background: "none", border: "none", cursor: "pointer", textAlign: "center" as const }) as React.CSSProperties,
  ...
  dimFuture: (changed: boolean) => ({ flex: 1, fontSize: "var(--text-xs)", color: changed ? "var(--amber)" : "var(--text-secondary)", fontWeight: changed ? "var(--fw-semi)" : "normal", padding: "4px 0" }) as React.CSSProperties,
  statusDot: (changed: boolean) => ({ display: "inline-block", width: 8, height: 8, borderRadius: "50%", background: changed ? "var(--amber)" : "var(--sage)", marginRight: 6, flexShrink: 0, marginTop: 6 }) as React.CSSProperties,
  ...
  btnDanger: { display: "inline-flex", alignItems: "center", gap: 4, padding: "8px 16px", fontSize: "var(--text-xs)", fontWeight: "var(--fw-medium)", border: "1px solid rgba(232,122,93,0.2)", borderRadius: 6, background: "rgba(232,122,93,0.05)", color: "var(--coral)", cursor: "pointer" } as React.CSSProperties,
  ...
  avatar: { width: 32, height: 32, borderRadius: "50%", background: "var(--paper-solid)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, color: "#fff", flexShrink: 0 } as React.CSSProperties,
  ...
  anchorBadge: { display: "inline-flex", alignItems: "center", gap: 3, padding: "2px 8px", fontSize: 11, background: "rgba(244,168,58,0.08)", border: "1px solid rgba(244,168,58,0.15)", borderRadius: 4, color: "var(--amber)", fontWeight: 600 } as React.CSSProperties,
};
                  ...
                  <div key={label as string} style={S.empField}>
                    ...
                    <div style={S.empFieldValue}>
                      ...
                      {label === "Working Title" && selectedEmployee.title !== c.title && (
                        <span style={{ marginLeft: 8, fontSize: 11, color: "var(--amber)", fontWeight: "var(--fw-medium)" }}>
                    ...
                    <div style={S.dimFuture(changed)}>
                      ...
                      {key === "track_code" && row.track_change && (
                        <div style={{ marginTop: 3 }}>
                          <span style={{ padding: "2px 6px", fontSize: 11, background: "rgba(244,168,58,0.1)", border: "1px solid rgba(244,168,58,0.2)", borderRadius: 3, color: "var(--amber)", fontWeight: 600 }}>Track change</span>
                        </div>
                      )}
                    </div>
                  </div>
