...
const S = {
  ...
  thRow: { background: "var(--paper-solid)" } as React.CSSProperties,
        ...
        <table ref={tableRef} style={S.table}>
          <thead>
            ...
            <tr style={S.thRow}>
              ...
              <th style={{ ...S.th, position: "sticky", left: 0, background: "var(--paper-solid)", zIndex: 2, minWidth: 200 }} onClick={() => toggleSort("title")}>
              ...
              return (
                ...
                >
                  ...
                  <td style={{ ...S.td, whiteSpace: "nowrap" }}>
                    {isAiPending && (
                      <>
                        <button style={S.actionBtn("var(--sage)")} title="Accept (a)"
                        ...
                        <button style={S.actionBtn("var(--coral)")} title="Reject (r)"
