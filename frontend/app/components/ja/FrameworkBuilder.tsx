...
const S = {
  ...
  gridHeader: { padding: "8px 10px", fontSize: 11, fontWeight: "var(--fw-semi)", color: "var(--text-muted)", textTransform: "uppercase" as const, letterSpacing: "0.04em", background: "#05070d", borderRadius: 4, textAlign: "center" as const } as React.CSSProperties,
  trackBadge: (code: string) => {
    const colors: Record<string, string> = { P: "#22d3ee", T: "#a78bfa", M: "#a78bfa", E: "#DC2626", S: "#14B8A6" };
