...
const S = {
  ...
  gridHeader: { padding: "8px 10px", fontSize: 11, fontWeight: "var(--fw-semi)", color: "var(--text-muted)", textTransform: "uppercase" as const, letterSpacing: "0.04em", background: "#1C2B3A", borderRadius: 4, textAlign: "center" as const } as React.CSSProperties,
  trackBadge: (code: string) => {
    const colors: Record<string, string> = { P: "#3B82F6", T: "#8B5CF6", M: "#F97316", E: "#DC2626", S: "#14B8A6" };
