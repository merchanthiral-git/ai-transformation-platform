...
export function LandingPage({ onNavigate, moduleStatus, hasData, viewMode }: { onNavigate: (id: string) => void; moduleStatus: Record<string, string>; hasData: boolean; viewMode?: string }) {
  ...
  return <div className="relative min-h-[calc(100vh-48px)] overflow-hidden">
    ...
    <div className="absolute inset-0 z-0" style={{ background: "linear-gradient(135deg, #0B1120 0%, #1a1530 35%, #0f1525 65%, #0a0f1a 100%)", backgroundImage: "url(/landing_bg.png)", backgroundSize: "cover", backgroundPosition: "center center", backgroundRepeat: "no-repeat" }} />
