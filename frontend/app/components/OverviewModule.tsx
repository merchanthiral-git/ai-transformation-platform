  ...
  return <div>
    ...
    <Card title="Investment & ROI Summary">
      <div className="grid grid-cols-4 gap-4">
        <div className="rounded-xl p-4 text-center border border-[var(--border)] bg-[var(--surface-2)]"><div className="text-[10px] text-[var(--text-muted)] uppercase mb-1">Total Investment</div><div className="text-[24px] font-extrabold text-[var(--text-primary)]">{fmtNum(bbba.total_investment || 0)}</div></div>
        <div className="rounded-xl p-4 text-center border border-[var(--border)] bg-[var(--surface-2)]"><div className="text-[10px] text-[var(--text-muted)] uppercase mb-1">Reskilling</div><div className="text-[24px] font-extrabold text-[var(--success)]">{fmtNum(bbba.reskilling_investment || reskill.total_investment || 0)}</div></div>
        <div className="rounded-xl p-4 text-center border border-[var(--border)] bg-[var(--surface-2)]"><div className="text-[10px] text-[var(--text-muted)] uppercase mb-1">Hiring</div><div className="text-[24px] font-extrabold text-[var(--accent-primary)]">{fmtNum(bbba.hiring_cost || 0)}</div></div>
        <div className="rounded-xl p-4 text-center border border-[var(--border)] bg-[var(--surface-2)]"><div className="text-[10px] text-[var(--text-muted)] uppercase mb-1">Manager Dev</div><div className="text-[24px] font-extrabold text-[var(--purple)]">{fmtNum((data?.manager_summary as Record<string,unknown>)?.total_investment || 0)}</div></div>
      </div>
    </Card>
