    ...
    printWin.document.write(`<!DOCTYPE html><html><head><title>Executive Summary — AI Transformation</title>
      ...
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { font-size: 22px; font-weight: 700; margin-bottom: 8px; color: #f4a83a; }
        h2 { font-size: 14px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; color: #a78bb8; margin: 20px 0 8px; border-bottom: 2px solid #f4a83a; padding-bottom: 4px; }
        .subtitle { font-size: 12px; color: #666; margin-bottom: 16px; }
        .overview { font-size: 13px; line-height: 1.6; margin-bottom: 16px; color: #333; }
        .kpi-row { display: flex; gap: 12px; margin-bottom: 16px; }
        .kpi { flex: 1; background: #f4ebd9; border-radius: 8px; padding: 12px; text-align: center; border-left: 3px solid #f4a83a; }
        .kpi-val { font-family: monospace; font-size: 18px; font-weight: 700; color: #f4a83a; }
