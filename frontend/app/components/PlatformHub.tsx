...
export function PlatformHub({ user, onBack, onUpdateUser }: { user: authApi.AuthUser; onBack: () => void; onUpdateUser: (u: authApi.AuthUser) => void }) {
  ...
  return <div className="flex min-h-screen w-full" style={{ background: "radial-gradient(ellipse at 30% 20%, rgba(22,24,34,0.6) 0%, transparent 50%), linear-gradient(135deg, #161822 0%, #0a1628 50%, #080e1e 100%)" }}>
    ...
    <aside className="w-[220px] min-h-screen flex flex-col px-3 py-5 shrink-0" style={{ height: "100vh", position: "sticky", top: 0, background: "var(--paper-solid)", borderRight: "1px solid rgba(244,168,58,0.06)" }}>
  ...
  return <div style={{ fontFamily: "'Inter Tight', 'Inter Tight', sans-serif" }}>
    ...
    <div style={{ padding: "80px 48px 100px", background: "linear-gradient(180deg, transparent 0%, rgba(244,168,58,0.02) 50%, transparent 100%)" }}>
      ...
      <div className="relative" style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <button onClick={() => setQuoteIdx((quoteIdx + 2) % 3)} style={{ position: "absolute", left: -64, top: "50%", transform: "translateY(-50%)", width: 48, height: 48, borderRadius: 14, background: "var(--border-light)", backdropFilter: "blur(8px)", border: "1px solid rgba(136,146,171,0.1)", color: "rgba(136,146,171,0.4)", fontSize: 20, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.2s", zIndex: 2 }} onMouseEnter={e => { e.currentTarget.style.color = "var(--accent-primary)"; e.currentTarget.style.borderColor = "rgba(244,168,58,0.3)"; e.currentTarget.style.background = "rgba(244,168,58,0.08)"; }} onMouseLeave={e => { e.currentTarget.style.color = "rgba(136,146,171,0.4)"; e.currentTarget.style.borderColor = "rgba(136,146,171,0.1)"; e.currentTarget.style.background = "var(--border-light)"; }}>{"\u2190"}</button>
        <button onClick={() => setQuoteIdx((quoteIdx + 1) % 3)} style={{ position: "absolute", right: -64, top: "50%", transform: "translateY(-50%)", width: 48, height: 48, borderRadius: 14, background: "var(--border-light)", backdropFilter: "blur(8px)", border: "1px solid rgba(136,146,171,0.1)", color: "rgba(136,146,171,0.4)", fontSize: 20, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.2s", zIndex: 2 }} onMouseEnter={e => { e.currentTarget.style.color = "var(--accent-primary)"; e.currentTarget.style.borderColor = "rgba(244,168,58,0.3)"; e.currentTarget.style.background = "rgba(244,168,58,0.08)"; }} onMouseLeave={e => { e.currentTarget.style.color = "rgba(136,146,171,0.4)"; e.currentTarget.style.borderColor = "rgba(136,146,171,0.1)"; e.currentTarget.style.background = "var(--border-light)"; }}>{"\u2192"}</button>
