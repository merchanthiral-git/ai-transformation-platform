...
`
    ...
    },
    {
      ...
      sections: [
        ...
        { id: "module-walkthrough", title: "Module-by-Module Walkthrough", content: `<h4>Discover Phase</h4><ul><li><strong>Dashboard</strong> — KPI summary, transformation progress <a class="try-it" data-navigate="dashboard">Open \u2192</a></li><li><strong>Workforce Snapshot</strong> — Headcount, demographics, cost <a class="try-it" data-navigate="snapshot">Open \u2192</a></li><li><strong>Job Architecture</strong> — Families, levels, spans <a class="try-it" data-navigate="jobarch">Open \u2192</a></li></ul><h4>Diagnose Phase</h4><ul><li><strong>Org Health</strong> — Six-dimension assessment <a class="try-it" data-navigate="orghealth">Open \u2192</a></li><li><strong>AI Opportunity Scan</strong> — Function-level exposure <a class="try-it" data-navigate="scan">Open \u2192</a></li><li><strong>Change Readiness</strong> — Employee readiness classification <a class="try-it" data-navigate="changeready">Open \u2192</a></li><li><strong>Manager Capability</strong> — Manager scoring (in Change Readiness) <a class="try-it" data-navigate="changeready">Open \u2192</a></li></ul><h4>Design Phase</h4><ul><li><strong>Work Design Lab</strong> — Task decomposition and redesign <a class="try-it" data-navigate="design">Open \u2192</a></li><li><strong>Skills & Talent</strong> — Gap analysis and reskilling <a class="try-it" data-navigate="skills">Open \u2192</a></li></ul><h4>Simulate & Mobilize</h4><ul><li><strong>Impact Simulator</strong> — Scenario modeling <a class="try-it" data-navigate="simulate">Open \u2192</a></li><li><strong>Change Planner</strong> — Roadmap and workstreams <a class="try-it" data-navigate="plan">Open \u2192</a></li><li><strong>Export</strong> — Generate deliverables <a class="try-it" data-navigate="export">Open \u2192</a></li></ul>` },
