...
export const PHASES = [
  ...
  { id: "diagnose", label: "Diagnose", icon: "🩺", color: "#FF8A3D", desc: "Find what matters most", guidance: "Now that you understand the landscape, let's identify the highest-impact opportunities and biggest risks.", modules: ["orghealth", "scan", "readiness", "changeready", "clusters", "mgrcap", "skills"] },
